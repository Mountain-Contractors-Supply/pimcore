...
1. From within the php container (`docker compose exec --user www-data -it php bash -l`) , run `bin/console importmap:install`
1. From within the php container (`docker compose exec --user www-data -it php bash -l`) , run `bin/console asset-map:compile`
